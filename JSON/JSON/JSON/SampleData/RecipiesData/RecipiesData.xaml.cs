...
namespace Blend.SampleData.RecipiesData
{
	using System; 
...
// the DISABLE_SAMPLE_DATA conditional compilation constant and disable sample data at runtime.
	...
	public class RecipiesData : INotifyPropertyChanged
	{
		...
		public RecipiesData()
		{
			try
			{
				Uri resourceUri = new Uri("ms-appx:/SampleData/RecipiesData/RecipiesData.xaml", UriKind.RelativeOrAbsolute);
